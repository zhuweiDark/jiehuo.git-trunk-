...
- (void)start
{
    ...
    //modiy by shituanwei@baidu.com 2012年11月13日17:58:08
    
    //[request setValue:@"baidu.com" forHTTPHeaderField:@"referer"];
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] initWithDictionary:request.allHTTPHeaderFields];
    [dic setValue:@"http://app.video.baidu.com" forKey:@"Referer"];
    [dic setObject:@"VideoiPhone" forKey:@"User-Agent"];

...
static double g_fAnimationDuration4OrientationChange = 0.0;
...
// animation duration
+ (double)setAnimationDuration4OrientationChange:(double)duration
{
    assert(duration >= 0.0);
    
    double old = g_fAnimationDuration4OrientationChange;
    g_fAnimationDuration4OrientationChange = duration;
    
    return old;
}

+ (double)getAnimationDuration4OrientationChange
{
    return g_fAnimationDuration4OrientationChange;
}
...
- (void)setTransformForCurrentOrientation:(BOOL)animated {	
	...
	if (animated) {
        ...
        [UIView setAnimationDuration:[[self class] getAnimationDuration4OrientationChange]];
	}
